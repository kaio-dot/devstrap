<img width="1536" height="1024" alt="devstrap" src="https://github.com/user-attachments/assets/a02f024c-fb53-453b-9d3d-cd48a6d82bee" />
...
```bash
go install github.com/kaio-dot/devstrap@latest
```
...
Contribuições são bem-vindas — ideias, issues, PRs ou tapas honestos na arquitetura.
...
MIT. Use, modifique, distribua. Só não diga que foi ideia sua 😄
